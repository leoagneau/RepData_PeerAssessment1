...
```
And there are **`r MissingSteps`** missing values in the step field.
...
```
The **`r MaxInt`** 5-minute interval contains the maximum number of steps.
